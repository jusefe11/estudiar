...
### Plataforma Cloud-Native · AWS · DevOps · DevSecOps

**Infraestructura como Código · Microservicios · CI/CD · Seguridad · Observabilidad**
...
![ECS](https://img.shields.io/badge/Amazon_ECS-Fargate-FF9900?logo=amazonaws)
...
**DEV:** 🟢 Operativo &nbsp; • &nbsp; **Sprints:** 6/8 &nbsp; • &nbsp; **Progreso:** 74%
...
| Capa | Componentes |
|---|---|
| 🌐 **Public Tier** | Internet Gateway, ALB, NAT Gateway |
| 🔒 **Private Tier** | ECS Fargate, Prometheus, Grafana |
| 🗄️ **Database Tier** | Amazon RDS PostgreSQL |
| 🔐 **Security** | Security Groups, NACL, IAM, KMS, Secrets Manager |
| 🔌 **Private AWS Access** | S3, ECR, CloudWatch Logs y STS mediante VPC Endpoints |
...
|:---:|---|:---:|
| **01** | 🌐 Arquitectura & Networking | 🟢 **100%** |
| **02** | 🐳 Docker & Amazon ECR | 🟢 **100%** |
| **03** | 🚀 ECS Fargate & ALB | 🟢 **100%** |
| **04** | 🗄️ Amazon RDS PostgreSQL | 🟢 **100%** |
| **05** | 🔄 GitHub Actions CI/CD | 🟡 **95%** |
| **06** | 📊 Observabilidad | 🟢 **100%** |
| **07** | 🛡️ Seguridad / DevSecOps | ⚪ **Pendiente** |
| **08** | ♻️ Alta disponibilidad / DR / Troubleshooting | ⚪ **Pendiente** |
...
| Servicio | Desired | Running | Pending |
|---|:---:|:---:|:---:|
| `bankcloud-dev-grafana` | 1 | **1** | 0 |
| `bankcloud-dev-prometheus` | 1 | **1** | 0 |
